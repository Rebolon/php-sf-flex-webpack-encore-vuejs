...
In this application i used Karma for one application with VueJS (in /assets/js/vuejs). And i used TestCafe to test pages fully generated by Symfony (i should use Panther now, it might be a better solution). 
