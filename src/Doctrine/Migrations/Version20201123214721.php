 ...
 */
final class Version20201123214721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_CC3F893CA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__reader AS SELECT id, user_id, lastname, firstname FROM reader');
        $this->addSql('DROP TABLE reader');
        $this->addSql('CREATE TABLE reader (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, lastname VARCHAR(255) NOT NULL COLLATE BINARY, firstname CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_CC3F893CA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO reader (id, user_id, lastname, firstname) SELECT id, user_id, lastname, firstname FROM __temp__reader');
        $this->addSql('DROP TABLE __temp__reader');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__reader AS SELECT id, user_id, lastname, firstname FROM reader');
        $this->addSql('DROP TABLE reader');
        $this->addSql('CREATE TABLE reader (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, lastname VARCHAR(255) NOT NULL, firstname CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO reader (id, user_id, lastname, firstname) SELECT id, user_id, lastname, firstname FROM __temp__reader');
        $this->addSql('DROP TABLE __temp__reader');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CC3F893CA76ED395 ON reader (user_id)');
        $this->addSql('DROP INDEX IDX_2A3845F31717D737');
