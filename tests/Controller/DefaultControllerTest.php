...
class DefaultControllerTest extends PantherToolsAbstract
{
    ...
    public function testDefaultController()
    {
        ...
        $this->assertStringContainsString('Demo of symfony 5 with flex, and webpack/encore, VueJS, ApiPlatform, HttpPlug,...', $crawler->filter('nav h1')->text()); // You can use any PHPUnit assertion
